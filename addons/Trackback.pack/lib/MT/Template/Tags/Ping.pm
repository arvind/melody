...
sub _hdlr_ping_score {
    ...
    return MT::Template::Context::_object_score_for('ping', @_);
}
...
sub _hdlr_ping_score_high {
    require MT::Template::Context;
    return MT::Template::Context::_object_score_high('ping', @_);
}
...
sub _hdlr_ping_score_low {
    require MT::Template::Context;
    return MT::Template::Context::_object_score_low('ping', @_);
}
...
sub _hdlr_ping_score_avg {
    require MT::Template::Context;
    return MT::Template::Context::_object_score_avg('ping', @_);
}
...
sub _hdlr_ping_score_count {
    require MT::Template::Context;
    return MT::Template::Context::_object_score_count('ping', @_);
}
...
sub _hdlr_ping_rank {
    require MT::Template::Context;
    return MT::Template::Context::_object_rank(
        'ping',
        {
